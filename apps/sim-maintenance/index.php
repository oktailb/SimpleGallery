<?php
/**
 * SimpleGallery WebOS - Sim Maintenance Standalone / iPad Mobile Entry Point
 * Fullscreen Touch-Optimized Web App for EC135 FFS Technicians
 */
...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Sim Maintenance">
    <meta name="format-detection" content="telephone=no">
    <title>Sim Maintenance — EC135 FFS (Standalone iPad)</title>
    
    <!-- Base Core Theme & Variables -->
    <link rel="stylesheet" href="../../themes/base.css">
    <link rel="stylesheet" href="../../themes/<?php echo htmlspecialchars($theme); ?>/theme.css">
    <!-- Sim Maintenance Styles -->
...
<body>
            ...
            window.sys.i18n = {
                ...
                setLocale: function (code) {
                    if (locales[code]) {
                        ...
                        if (window.simMaintenanceApp && typeof window.simMaintenanceApp.onLocaleChanged === 'function') {
                            window.simMaintenanceApp.onLocaleChanged();
                        }
                    }
                }
            };
    ...
    <!-- Sim Maintenance Engine -->
    <script src="app.js"></script>

    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var container = document.getElementById('standalone-container');
            if (window.simMaintenanceApp && typeof window.simMaintenanceApp.init === 'function') {
                window.simMaintenanceApp.init(container);
            }
        });
    </script>
</body>
